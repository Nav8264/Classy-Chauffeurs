...
import { AirportTransfer } from "../../component/AirportTransfer/AirportTransfer.js";

import service1 from "../../images/earth.jpg";
import trophy from "../../images/tropy.jpg";
  ...
  return (
    <>
      {loading ? (
        ...
        <div>
          <AirportTransfer highlights={highlights} currentAirport={airport} />

          {/* static below */}

          <div className="h-full  w-full pl-0 mt-[2rem]">
            <Swiper
              spaceBetween={10}
              slidesPerView={1}
              pagination={{
